# 在 AMD ROCm DSW 上部署 Qwen3.6-27B-FP8：vLLM、MTP 解码加速、8K 正确性与小并发压测
...
![Forced 1024-token decode](../figures/round4_forced_1024_decode.png)
...
![Small-concurrency serving throughput](../figures/round5_concurrency_serving.png)
